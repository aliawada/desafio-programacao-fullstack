        ...
        <nav>
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div className="flex md:order-2">
              <button type="button" className="text-white bg-gray-700 font-medium rounded-md text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-gray-900 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Upload File</button>
            </div>
